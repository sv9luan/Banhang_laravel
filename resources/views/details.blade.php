            ...
            <div class="col-lg-5">
                ...
                <div class="product-single__addtolinks">
                    ...
                    <form method="POST" action="{{route('wishlist.remove',['rowId'=>Cart::instance("wishlist")->content()->Where('id',$product->id)->first()->rowId])}}">
                        @csrf
                        @method("DELETE")
                        <button href="javascript:void(0);" class="menu-link menu-link_us-s add-to-wishlist filled-heart js-add-wishlist border-0
                        bg-transparent d-flex align-items-center"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <use href="#icon_heart" />
