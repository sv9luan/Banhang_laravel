...
<main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="products-grid row row-cols-2 row-cols-md-3" id="products-grid">
          ...
          <div class="product-card-wrapper">
            ...
            <form method="POST" action="{{route('wishlist.items.remove',['rowId'=>Cart::instance("wishlist")->content()->Where('id',$product->id)->first()->rowId])}}">
                @csrf
                @method("DELETE")
                    <button type="submit" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 filled-heart js-add-wishlist" title="Remove from Wishlist">
        ...
        <div class="flex items-center justify-between flew-wrap gap10 wgp-pagination">
